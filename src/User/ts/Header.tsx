...
function Header() {
  ...
  return (
    <div className="top-0 left-0 w-full bg-white text-[#0c2c4c] flex items-center py-4 px-4 z-50 border-b-[10px] border-[#0c2c4c] shadow-md min-h-[70px]">
      ...
      <div className={`${isNavMenuOpen ? 'flex' : 'hidden'} md:flex flex-grow justify-start absolute md:relative top-[70px] left-0 bg-white w-full md:w-auto md:top-auto p-4 md:p-0 shadow-md md:shadow-none z-50`}>
        <div className="px-2 py-1 rounded-lg w-full md:w-auto">
          <ul className="flex flex-col md:flex-row gap-4 md:gap-8 text-sm sm:text-base md:text-lg lg:text-xl font-bold uppercase">
            <li><Link to="/" className="hover:text-gray-400 block py-2 md:py-0">Inicio</Link></li>
            <li><Link to="/Categories" className="hover:text-gray-400 block py-2 md:py-0">Categorías</Link></li>
            <li><a href="#" className="hover:text-gray-400 block py-2 md:py-0">Top Sellers</a></li>
          </ul>
        </div>
      </div>
